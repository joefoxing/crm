...
class IntegrationTestCreditLedgerEntry(IntegrationTestCase):
	...
	def test_submit_marks_sync_success_when_push_succeeds(self):
		from unittest.mock import patch

		contract = frappe.get_doc(
			{
				"doctype": "Tripartite Contract",
				"contract_id": "HD-3B-2026-004",
				"credit_limit": 200000000,
			}
		).insert()
		...
		contract.reload()
		self.assertEqual(contract.sync_status, "Synced")
		self.assertIsNotNone(contract.last_synced_at)
